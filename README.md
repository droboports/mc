...
Check the [releases](https://github.com/droboports/mc/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/mc.git
cd mc
./build.sh
ls -la *.tgz
```
